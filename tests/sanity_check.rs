...
fn test_toroidal_next_gen() {
    ...
    assert_eq!(0, new_grid.get_cell_state(0, 2));
    assert_eq!(0, new_grid.get_cell_state(0, 3));
    assert_eq!(0, new_grid.get_cell_state(0, 4));
    assert_eq!(0, new_grid.get_cell_state(1, 0));
    assert_eq!(0, new_grid.get_cell_state(1, 1));
    assert_eq!(255, new_grid.get_cell_state(1, 2));
    assert_eq!(0, new_grid.get_cell_state(1, 3));
    assert_eq!(0, new_grid.get_cell_state(1, 4));
    assert_eq!(0, new_grid.get_cell_state(2, 0));
    assert_eq!(0, new_grid.get_cell_state(2, 1));
    assert_eq!(255, new_grid.get_cell_state(2, 2));
    assert_eq!(0, new_grid.get_cell_state(2, 3));
    assert_eq!(0, new_grid.get_cell_state(2, 4));
    assert_eq!(0, new_grid.get_cell_state(3, 0));
    assert_eq!(0, new_grid.get_cell_state(3, 1));
    assert_eq!(255, new_grid.get_cell_state(3, 2));
    assert_eq!(0, new_grid.get_cell_state(3, 3));
    assert_eq!(0, new_grid.get_cell_state(3, 4));
    assert_eq!(0, new_grid.get_cell_state(4, 0));
    assert_eq!(0, new_grid.get_cell_state(4, 1));
    assert_eq!(0, new_grid.get_cell_state(4, 2));
    assert_eq!(0, new_grid.get_cell_state(4, 3));
    assert_eq!(0, new_grid.get_cell_state(4, 4));
}
...
fn test_resizable_load_file() {
    ...
    assert_eq!(0, grid.get_cell_state(0, 4));
    assert_eq!(0, grid.get_cell_state(1, 0));
    assert_eq!(255, grid.get_cell_state(1, 1));
    assert_eq!(255, grid.get_cell_state(1, 2));
    assert_eq!(255, grid.get_cell_state(1, 3));
    assert_eq!(0, grid.get_cell_state(1, 4));
    assert_eq!(0, grid.get_cell_state(2, 0));
...
fn test_resizable_next_gen() {
    ...
    assert_eq!(0, new_grid.get_cell_state(0, 3));
    assert_eq!(0, new_grid.get_cell_state(0, 4));
    assert_eq!(0, new_grid.get_cell_state(0, 5));
    assert_eq!(0, new_grid.get_cell_state(0, 6));
    assert_eq!(0, new_grid.get_cell_state(1, 0));
    assert_eq!(0, new_grid.get_cell_state(1, 1));
    assert_eq!(0, new_grid.get_cell_state(1, 2));
    assert_eq!(255, new_grid.get_cell_state(1, 3));
    assert_eq!(0, new_grid.get_cell_state(1, 4));
    assert_eq!(0, new_grid.get_cell_state(1, 5));
    assert_eq!(0, new_grid.get_cell_state(1, 6));
    assert_eq!(0, new_grid.get_cell_state(2, 0));
    assert_eq!(0, new_grid.get_cell_state(2, 1));
    assert_eq!(0, new_grid.get_cell_state(2, 2));
    assert_eq!(255, new_grid.get_cell_state(2, 3));
    assert_eq!(0, new_grid.get_cell_state(2, 4));
    assert_eq!(0, new_grid.get_cell_state(2, 5));
    assert_eq!(0, new_grid.get_cell_state(2, 6));
    assert_eq!(0, new_grid.get_cell_state(3, 0));
    assert_eq!(0, new_grid.get_cell_state(3, 1));
    assert_eq!(0, new_grid.get_cell_state(3, 2));
    assert_eq!(255, new_grid.get_cell_state(3, 3));
    assert_eq!(0, new_grid.get_cell_state(3, 4));
    assert_eq!(0, new_grid.get_cell_state(3, 5));
    assert_eq!(0, new_grid.get_cell_state(3, 6));
    assert_eq!(0, new_grid.get_cell_state(4, 0));
    assert_eq!(0, new_grid.get_cell_state(4, 1));
    assert_eq!(0, new_grid.get_cell_state(4, 2));
    assert_eq!(0, new_grid.get_cell_state(4, 3));
    assert_eq!(0, new_grid.get_cell_state(4, 4));
    assert_eq!(0, new_grid.get_cell_state(4, 5));
    assert_eq!(0, new_grid.get_cell_state(4, 6));
}
